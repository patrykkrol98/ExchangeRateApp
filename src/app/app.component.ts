...
export class AppComponent implements OnInit {
    ...
    ngOnInit(): void {
        //todo try to avoid using Subscription object inside components
        //todo OBSERVABLE VS SUBSCRIPTION
        this.subApi = this.route.params.subscribe(
            params => {
                this.curBase = this.curBase !== params['curSec'] && params['curSec'] ? params['curSec'] : 'EUR';
